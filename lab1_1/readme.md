Домашнее задание к занятию 1 Типы данных. Первая программа на c#
==
...
1. [Автор программы](/lab1_1/1.1.1/)
2. [Приветствуем пользователя](/lab1_1/1.1.2/).
3. [Приветствуем пользователя и узнаем его возраст](/lab1_1/1.1.3/) *(не обязательна к выполнению).
