# Домашние задания по курсу «Основы C#»
...
9. В классе на сайте [classroom.google](https://classroom.google.com/c/MjM5MzEwOTA3NTJa) в поле комментария к домашней работе вставьте скопированную ссылку и отправьте работу на проверку.
...
8. В классе на сайте [classroom.google](https://classroom.google.com/c/MjM5MzEwOTA3NTJa) в поле комментария к домашней работе вставьте zip архив проета и отправьте работу на проверку.

*Для подробной информации перейдите по [ссылке](https://docs.microsoft.com/ru-ru/dotnet/core/tutorials/with-visual-studio-code).*