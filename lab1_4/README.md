Домашнее задание к занятию 4. Циклы `FOR & WHILE & DO-WHILE`.
==

Привет! 

Для некоторых задач вам потребуется использовать библиотеку [Math](http://ctrockii.blogspot.com/2012/06/c-math.html).

Выполните задачи для реализации различных функций приложения (для выполнения задач воспользуйтесь инструкцией ниже):

1. [Сборник мини задач на `FOR`](/lab1_4/1.4.1/).
2. [Сборник мини задач на `WHILE`](/lab1_4/1.4.2/).
